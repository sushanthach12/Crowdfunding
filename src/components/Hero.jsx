...
const Hero = () => {
    return (
        <motion.section
            ...
            className='bg-bgImage bg-cover h-[80vh] py-10'>
            <div className="relative px-6 lg:px-8">
                <div className="mx-auto max-w-2xl py-10 sm:py-48 lg:py-20">
                  
                    <div className="text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-blue-900 sm:text-6xl">Your home</h1>
                        <h1 className="text-4xl font-bold tracking-tight text-blue-900 sm:text-6xl py-2">for help</h1>
                        <p className="mt-6 text-lg leading-8 text-gray-600">A Little Care Can Change the World !</p>
